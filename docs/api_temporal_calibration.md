...
This page collects the public interfaces introduced by Propositions 41 through 51. It is intentionally separate from the older general API guide so a reader can follow the temporal-dependence theorem ladder in one place.

The mathematical assumptions are summarized here, but the complete application rules remain in the [assumption ledger](assumption_ledger.md).
...
Proposition 51 currently lives in its dedicated public module:
