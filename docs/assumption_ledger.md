...
| The dependent covariance is formed without estimating the mean from the same observations | Proposition 41 and Experiment AA | Same-sample centering changes the quadratic form and requires an additional error argument |
