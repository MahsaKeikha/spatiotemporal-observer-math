...
Can observer identity be derived as a persistent path through factorization
space rather than assumed as a fixed set of physical degrees of freedom?
...
- Formalize the quotient space of tensor factorizations.
- Identify its tangent-space decomposition and gauge-invariant metric.
- Define a covariant derivative for transported subsystem states.
- Study geodesics, curvature, and holonomy as possible signatures of persistent
...
## Phase 5: empirical contact

- Validate first on simulated systems with known ground truth.
- Pre-register null models and ablations.
