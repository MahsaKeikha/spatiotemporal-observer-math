...
connects the central question, all 37 proved statements, all 23 reproducible
...
| --- | --- |
| [Proved statements](docs/proofs_and_conjectures.md) | 37 propositions |
| [Reproducible studies](docs/reproducible_results.md) | 23 experiments, A through W |
| [Scientific figures](docs/research_overview.md#visual-record-of-the-results) | 10 committed figures |
| [Claim-level tests](docs/experimental_protocol.md#9-tests-tied-to-scientific-claims) | 106 of 106 passing |
...
| Document | Contents |
| --- | --- |
| [Research overview](docs/research_overview.md) | One-page map of the question, 37 propositions, 23 experiments, evidence, code, and limitations |
...
| [Proved results and open problems](docs/proofs_and_conjectures.md) | Thirty-seven proved statements and the remaining sharpness questions |
...
This is an ongoing study, not a finished paper. Version 0.25.0 adds the
covariance-normalized perturbation theorem and its paired 18-regime visual and
numerical record, available from the landing page. Every proposition, experiment, figure,
