...
connects the central question, all 38 proved statements, all 24 reproducible
...
| --- | --- |
| [Proved statements](docs/proofs_and_conjectures.md) | 38 propositions |
| [Reproducible studies](docs/reproducible_results.md) | 24 experiments, A through X |
| [Scientific figures](docs/research_overview.md#visual-record-of-the-results) | 11 committed figures |
| [Claim-level tests](docs/experimental_protocol.md#9-tests-tied-to-scientific-claims) | 109 of 109 passing |
...
safe graph in every tested regime.

## Read the project

| Document | Contents |
| --- | --- |
| [Research overview](docs/research_overview.md) | One-page map of the question, 38 propositions, 24 experiments, evidence, code, and limitations |
...
| [Proved results and open problems](docs/proofs_and_conjectures.md) | Thirty-eight proved statements and the remaining sharpness questions |
...
construction remain open work. The new normalization result addresses one
source of conservatism; observable adaptive radii and non-Gaussian guarantees
remain open.
...
This is an ongoing study, not a finished paper. Version 0.26.0 adds the
pilot-normalized adaptive-screening theorem and its 18-regime visual and
numerical record, available from the landing page. Every proposition,
