...
| --- | --- |
| [Proved statements](docs/proofs_and_conjectures.md) | 35 propositions |
| [Reproducible studies](docs/reproducible_results.md) | 20 experiments, A through T |
| [Scientific figures](docs/research_overview.md#visual-record-of-the-results) | 7 committed figures |
| [Claim-level tests](docs/experimental_protocol.md#9-tests-tied-to-scientific-claims) | 94 of 94 passing |
...
This is an ongoing study, not a finished paper. Version 0.22.2 presents the
