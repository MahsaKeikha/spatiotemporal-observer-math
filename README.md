...
connects the central question, all 41 proved statements, all 27 reproducible
...
| --- | --- |
| [Proved statements](docs/proofs_and_conjectures.md) | 41 propositions |
| [Reproducible studies](docs/reproducible_results.md) | 27 experiments, A through Z and AA |
| [Scientific figures](docs/research_overview.md#visual-record-of-the-results) | 14 committed figures |
| [Claim-level tests](docs/experimental_protocol.md#9-tests-tied-to-scientific-claims) | 120 of 120 passing |
...
theorem: estimated means, estimated correlation, and nonseparable sliding
windows remain open.
...
| Document | Contents |
| --- | --- |
| [Research overview](docs/research_overview.md) | One-page map of the question, 41 propositions, 27 experiments, evidence, code, and limitations |
...
| [Proved results and open problems](docs/proofs_and_conjectures.md) | Forty-one proved statements and the remaining sharpness questions |
...
construction remain open work. A separable known-mean Gaussian dependence model
is now covered, but estimated dependence, general sliding windows, and
non-Gaussian guarantees remain open.
...
This is an ongoing study, not a finished paper. Version 0.29.0 adds a
dependence-aware Gaussian covariance theorem, an end-to-end structural-null
screen, and a stationary AR(1) calibration. Every proposition,
