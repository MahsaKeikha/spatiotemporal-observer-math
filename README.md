...
connects the central question, all 39 proved statements, all 25 reproducible
...
| --- | --- |
| [Proved statements](docs/proofs_and_conjectures.md) | 39 propositions |
| [Reproducible studies](docs/reproducible_results.md) | 25 experiments, A through Y |
| [Scientific figures](docs/research_overview.md#visual-record-of-the-results) | 12 committed figures |
| [Claim-level tests](docs/experimental_protocol.md#9-tests-tied-to-scientific-claims) | 112 of 112 passing |
...
| Document | Contents |
| --- | --- |
| [Research overview](docs/research_overview.md) | One-page map of the question, 39 propositions, 25 experiments, evidence, code, and limitations |
...
| [Proved results and open problems](docs/proofs_and_conjectures.md) | Thirty-nine proved statements and the remaining sharpness questions |
...
construction remain open work. The drift result requires an independently
justified covariance envelope; dependent-window and non-Gaussian guarantees
remain open.
...
This is an ongoing study, not a finished paper. Version 0.27.0 adds the
drift-robust pilot-normalized theorem and its structure-preserving drift
calibration, including the observed loss-of-selectivity boundary. Every proposition,
