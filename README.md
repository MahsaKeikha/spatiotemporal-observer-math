...
connects the central question, all 40 proved statements, all 26 reproducible
...
| --- | --- |
| [Proved statements](docs/proofs_and_conjectures.md) | 40 propositions |
| [Reproducible studies](docs/reproducible_results.md) | 26 experiments, A through Z |
| [Scientific figures](docs/research_overview.md#visual-record-of-the-results) | 13 committed figures |
| [Claim-level tests](docs/experimental_protocol.md#9-tests-tied-to-scientific-claims) | 116 of 116 passing |
...
| Document | Contents |
| --- | --- |
| [Research overview](docs/research_overview.md) | One-page map of the question, 40 propositions, 26 experiments, evidence, code, and limitations |
...
| [Proved results and open problems](docs/proofs_and_conjectures.md) | Forty proved statements and the remaining sharpness questions |
...
construction remain open work. Drift can now be calibrated under the Gaussian
model, but dependent-window and non-Gaussian guarantees remain open.
...
This is an ongoing study, not a finished paper. Version 0.28.0 adds a
confidence-budgeted drift estimator and the paired old-versus-refreshed
reference comparison. Every proposition,
