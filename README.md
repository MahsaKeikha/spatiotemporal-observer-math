...
connects the central question, all 36 proved statements, all 21 reproducible
...
| [Reproducible studies](docs/reproducible_results.md) | 21 experiments, A through U |
| [Scientific figures](docs/research_overview.md#visual-record-of-the-results) | 8 committed figures |
| [Claim-level tests](docs/experimental_protocol.md#9-tests-tied-to-scientific-claims) | 100 of 100 passing |
...
| Document | Contents |
| --- | --- |
| [Research overview](docs/research_overview.md) | One-page map of the question, 36 propositions, 21 experiments, evidence, code, and limitations |
...
This is an ongoing study, not a finished paper. Version 0.23.0 adds the
trajectory-coupled Gaussian calibration and corrects the structural-null mask
to exclude seven weakly positive covariance-memory states. Every proposition,
experiment, figure, command, and limitation can be followed from the central
visual overview to its detailed source. The repository will change as
higher-precision calibration, counterexamples, comparisons, and sharper proofs
are added.
