...
connects the central question, all 42 proved statements, all 28 reproducible
...
| --- | --- |
| [Proved statements](docs/proofs_and_conjectures.md) | 42 propositions |
| [Reproducible studies](docs/reproducible_results.md) | 28 experiments, A through Z, AA, and AB |
| [Scientific figures](docs/research_overview.md#visual-record-of-the-results) | 15 committed figures |
| [Claim-level tests](docs/experimental_protocol.md#9-tests-tied-to-scientific-claims) | 125 of 125 passing |
...
theorem: its known-mean restriction is addressed by Proposition 42, while
estimated correlation and nonseparable sliding windows remain open.
...
is constant, and space-time covariance is separable.

## Read the project

| Document | Contents |
| --- | --- |
| [Research overview](docs/research_overview.md) | One-page map of the question, 42 propositions, 28 experiments, evidence, code, and limitations |
...
| [Proved results and open problems](docs/proofs_and_conjectures.md) | Forty-two proved statements and the remaining sharpness questions |
...
unknown constant mean is now covered, but estimated temporal dependence,
time-varying means, general sliding windows, and non-Gaussian guarantees remain
open.
...
This is an ongoing study, not a finished paper. Version 0.30.0 adds the exact
mean-centering correction for separably dependent Gaussian observations, its
end-to-end screen, and a stationary AR(1) calibration. Every proposition,
