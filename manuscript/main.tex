...
\begin{abstract}
Prior work proposed that observer-like physical systems may be distinguished by
...
The perceptronium framework asks which physical properties distinguish
observer-like matter and whether those properties can help select the spatial
factorization perceived by observers \citep{consciousness_state_matter_2015}. It exposes a
